    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
            <div class="col-md-8 ftco-animate mt-5 pt-md-5" data-scrollax=" properties: { translateY: '70%' }">
                <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Selamat Datang<br></h1>
                <div class="row">
                    <div class="col-md-7">
                        <p class="mb-4 pl-md-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"> Ingin lebih kenal dengan PT. Hikmah Jaya Putra ? </p>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row justify-content-center pb-5">
            <div class="col-lg-7 heading-section text-center ftco-animate">
                <h2 class="mb-4">Selama lebih dari <span>17</span> tahun kami melayani</h2>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="services-2 text-center">
                    <div class="icon">
                        ...
                        <img src="image/engineering_outline.png" alt="" srcset="">
                    </div>
                    <div class="text">
            ...
            <div class="col-md-3">
                <div class="services-2 text-center">
                    <div class="icon">
                        <!-- <span class="flaticon-web-programming"></span> -->
                        <img src="image/people_outline.png" alt="" srcset="">
                    </div>
                    <div class="text">
                        <h3>Man Power Supply</h3>
                        <p>Penyediaan dan jasa penempatan tenaga kerja sesuai dengan kebutuhan</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="services-2 text-center">
                    <div class="icon">
                        <!-- <span class="flaticon-web-programming"></span> -->
                        <img src="image/localshipping_outline.png" alt="" srcset="">
                    </div>
                    <div class="text">
                        <h3>General Trading</h3>
                        <p>Penyediaan barang kebutuhan industri yang dibutuhkan sebagai penunjang kegiatan produksi</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="services-2 text-center">
                    <div class="icon">
                        <!-- <span class="flaticon-web-programming"></span> -->
                        <img src="image/construction_outline.png" alt="" srcset="">
                    </div>
                    <div class="text">
                        <h3>Maintenance</h3>
